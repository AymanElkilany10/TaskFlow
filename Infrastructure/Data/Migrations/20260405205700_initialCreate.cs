...
namespace TaskFlow.Infrastructure.Data.Migrations
{
    ...
    public partial class initialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Columns_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_TenantId_WorkspaceId_Name",
                table: "Projects",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_TenantId_ColumnId_Position",
                table: "Tasks",
                columns: new[] { "TenantId", "ColumnId", "Position" });
